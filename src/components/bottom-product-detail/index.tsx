      ...
      <article className="flex-2 flex flex-col gap-1">
        <span className=" text-[var(--color-price-rebate)]">
          ...
          <span className="text-red-500 line-through">
            <span className="text-[var(--color-price-rebate)]">{format.format(product.price)}</span>
          </span>
        </span>
        ...
        <span className="text-4xl font-semibold pt-2">{format.format(product.total)}</span>
      </article>
